...
module.exports = (editor) ->
  ...
  editor.projects.on 'add', (project) ->
    ...
    applyFilters = ({image, filters}, callback) ->
      async.series (Object.keys filters), (key, callback) ->
        console.time key
        setInterval ->
          console.timeEnd key
          callback null
    ...
    class Job
      ...
      run: (callback) ->
        applyFilters image: @image, filters: @filters, callback
    
    images = (new Image id: i) for i in [0...5]
